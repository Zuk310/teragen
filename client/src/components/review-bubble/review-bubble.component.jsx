...
const ReviewBubble = () => {
  ...
  return (
    ...
    <ReviewBubbleDeleteIcon width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M12.6213 7.8787L8.37867 12.1213" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M8.37867 7.87862L12.6213 12.1213" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
